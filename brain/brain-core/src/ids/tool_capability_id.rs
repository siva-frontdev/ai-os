...
impl Default for ToolCapabilityId {
    fn default() -> Self {
        Self::new()
    }
}
...
impl FromStr for ToolCapabilityId {
    type Err = uuid::Error;
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Uuid::from_str(s).map(Self)
    }
}
impl From<Uuid> for ToolCapabilityId {
    fn from(uuid: Uuid) -> Self {
        Self(uuid)
    }
}
impl From<ToolCapabilityId> for Uuid {
    fn from(id: ToolCapabilityId) -> Self {
        id.0
    }
}
